...
function run_acdcsw_DC_reformulation(file, model_constructor, optimizer; kwargs...)
    return _PM.solve_model(file, model_constructor, optimizer, build_acdcsw_DC_reformulation; ref_extensions=[add_ref_dcgrid_dcswitch!,_PM.ref_add_on_off_va_bounds!], kwargs...)
end

""
function build_acdcsw_DC_reformulation(pm::_PM.AbstractPowerModel)
    # AC grid
